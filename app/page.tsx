        ...
        <div className="flex flex-col items-center justify-center mt-6 gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              ...
              className="border border-blue-500 text-blue-500 rounded-md px-4 py-2 hover:bg-blue-50 transition"
            >
            ...
            <button
              ...
              className="border border-purple-500 text-purple-500 rounded-md px-4 py-2 hover:bg-purple-50 transition"
            >
